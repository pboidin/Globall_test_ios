...
struct FootballPlaygroundTwoView: View {
    @StateObject var footballPlaygroundTwoViewModel = FootballPlaygroundTwoViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_20")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack {
                            ...
                            .frame(width: getRelativeWidth(221.0), height: getRelativeHeight(29.0),
                                   alignment: .leading)
                ...
                Group {
                    NavigationLink(destination: MapsFootballView(),
                                   ...
                                   selection: $footballPlaygroundTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct FootballPlaygroundTwoView_Previews: PreviewProvider {
    static var previews: some View {
        FootballPlaygroundTwoView()
    }
}
