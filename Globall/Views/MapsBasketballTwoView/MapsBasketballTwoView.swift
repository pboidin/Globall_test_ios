...
struct MapsBasketballTwoView: View {
    @StateObject var mapsBasketballTwoViewModel = MapsBasketballTwoViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_11")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Button(action: {
                                mapsBasketballTwoViewModel.nextScreen = "MapsFootballView"
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: BasketballPlaygroundTwoView(),
                                   ...
                                   selection: $mapsBasketballTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct MapsBasketballTwoView_Previews: PreviewProvider {
    static var previews: some View {
        MapsBasketballTwoView()
    }
}
