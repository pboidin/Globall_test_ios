...
struct MapsBasketballView: View {
    @StateObject var mapsBasketballViewModel = MapsBasketballViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_8")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Button(action: {
                                mapsBasketballViewModel.nextScreen = "MapsFootballView"
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: MapsBasketballTwoView(),
                                   ...
                                   selection: $mapsBasketballViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct MapsBasketballView_Previews: PreviewProvider {
