...
struct MapsBasketballOneView: View {
    @StateObject var mapsBasketballOneViewModel = MapsBasketballOneViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_12")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            ZStack(alignment: .topTrailing) {
                                ...
                                VStack {
                                    ...
                                    Image("img_vector1")
                                        ...
                                        .onTapGesture {
                                            mapsBasketballOneViewModel
                                                .nextScreen = "MapsBasketballThreeView"
                                        }
                                }
                                .frame(width: getRelativeWidth(218.0),
                                       height: getRelativeHeight(205.0), alignment: .topTrailing)
                            ...
                            Button(action: {
                                mapsBasketballOneViewModel.nextScreen = "MapsFootballView"
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: HomePageView(),
                                   tag: "HomePageView",
                                   selection: $mapsBasketballOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct MapsBasketballOneView_Previews: PreviewProvider {
    static var previews: some View {
        MapsBasketballOneView()
    }
}
