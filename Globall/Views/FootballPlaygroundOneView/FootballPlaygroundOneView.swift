...
struct FootballPlaygroundOneView: View {
    @StateObject var footballPlaygroundOneViewModel = FootballPlaygroundOneViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_19")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                ...
                                Text(StringConstants.kMsgLuxembourgCour)
                                    .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(257.0), height: getRelativeHeight(29.0),
                                   alignment: .leading)
                ...
                Group {
                    NavigationLink(destination: HomePageView(),
                                   tag: "HomePageView",
                                   selection: $footballPlaygroundOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct FootballPlaygroundOneView_Previews: PreviewProvider {
    static var previews: some View {
        FootballPlaygroundOneView()
    }
}
