...
struct BasketballPlaygroundThreeView: View {
    @StateObject var basketballPlaygroundThreeViewModel = BasketballPlaygroundThreeViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_16")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                ...
                                Text(StringConstants.kLblEiffelCourt)
                                    .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(213.0), height: getRelativeHeight(26.0),
                                   alignment: .leading)
                            .padding(.horizontal, getRelativeWidth(10.0))
                            Image("img_toureiffelcourt")
                                .resizable()
                ...
                Group {
                    NavigationLink(destination: MapsFootballView(),
                                   ...
                                   selection: $basketballPlaygroundThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct BasketballPlaygroundThreeView_Previews: PreviewProvider {
    static var previews: some View {
        BasketballPlaygroundThreeView()
    }
}
