...
struct BasketballPlaygroundTwoView: View {
    @StateObject var basketballPlaygroundTwoViewModel = BasketballPlaygroundTwoViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_17")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                ...
                                Text(StringConstants.kMsgEscpRPuCour)
                                    .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(249.0), height: getRelativeHeight(26.0),
                                   alignment: .leading)
                            .padding(.horizontal, getRelativeWidth(10.0))
                            Image("img_terraindebask")
                                .resizable()
                ...
                Group {
                    NavigationLink(destination: EventsView(),
                                   tag: "EventsView",
                                   selection: $basketballPlaygroundTwoViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct BasketballPlaygroundTwoView_Previews: PreviewProvider {
    static var previews: some View {
        BasketballPlaygroundTwoView()
    }
}
