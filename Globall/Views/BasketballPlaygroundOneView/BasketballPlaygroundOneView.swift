...
struct BasketballPlaygroundOneView: View {
    @StateObject var basketballPlaygroundOneViewModel = BasketballPlaygroundOneViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_18")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                ...
                                Text(StringConstants.kLbl42Court)
                                    .font(FontScheme
                            ...
                            .frame(width: getRelativeWidth(200.0), height: getRelativeHeight(26.0),
                                   alignment: .leading)
                ...
                Group {
                    NavigationLink(destination: MapsFootballView(),
                                   ...
                                   selection: $basketballPlaygroundOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct BasketballPlaygroundOneView_Previews: PreviewProvider {
    static var previews: some View {
        BasketballPlaygroundOneView()
    }
}
