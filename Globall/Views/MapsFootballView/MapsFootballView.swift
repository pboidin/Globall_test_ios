...
struct MapsFootballView: View {
    @StateObject var mapsFootballViewModel = MapsFootballViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .center) {
                    Image("img_whitebackgroun_9")
                        .resizable()
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Button(action: {
                                mapsFootballViewModel.nextScreen = "MapsBasketballView"
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: MapsFootballOneView(),
                                   ...
                                   selection: $mapsFootballViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct MapsFootballView_Previews: PreviewProvider {
